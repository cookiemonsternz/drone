...
// Enable gyro clkin timer
#define USE_GYRO_CLKIN

#define USE_BARO
#define USE_BARO_BMP280

// Technically wrong flash chip but the other define
// is for quad/octo spi
#define USE_FLASH
...
// DISABLED FOR NOW AS UNTESTED, MAY NEED TO ADD MOSFET
